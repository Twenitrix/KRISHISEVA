  ...
  return (
    <div className="min-h-screen bg-paper flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold text-text-primary tracking-tight">{t('auth.ngoLoginTitle')}</h1>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <Card className="px-6 py-8 relative overflow-hidden">
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/ngo/register" className="font-medium text-accent hover:text-accent-hover">
              {t('auth.registerLink')}
            </Link>
          </div>
        </Card>
